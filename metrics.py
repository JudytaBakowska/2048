...
def get_score(grid, *params):
    ...
    # print("empty: ", empty_tiles_score)
    # print("max_value: ", max_value_score)
    # print("smoothness: ", smoothness_score)
    # print("weighted: ",weighted_tiles_score)
    ...
    # score = weighted_tiles_score
    score = params[0] * empty_tiles_score + params[1] * position_score
